...
type Geometry struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Geometry      []*Coordinate          `protobuf:"bytes,1,rep,name=geometry,proto3" json:"geometry,omitempty"`
...
func (x *Geometry) GetGeometry() []*Coordinate {
	if x != nil {
		return x.Geometry
	}
	return nil
...
func (x *Geometry) GetDistance() float64 {
	if x != nil {
		return x.Distance
	}
	return 0
...
func (x *Geometry) GetDuration() float64 {
	if x != nil {
		return x.Duration
	}
	return 0
...
const file_trip_proto_rawDesc = "" +
	...
	"\bGeometry\x12,\n" +
	"\bgeometry\x18\x01 \x03(\v2\x10.trip.CoordinateR\bgeometry\x12\x1a\n" +
	"\bdistance\x18\x02 \x01(\x01R\bdistance\x12\x1a\n" +
	"\bduration\x18\x03 \x01(\x01R\bduration\"k\n" +
	"\x05Route\x12*\n" +
...
var file_trip_proto_depIdxs = []int32{
	...
	2, // 4: trip.Geometry.geometry:type_name -> trip.Coordinate
